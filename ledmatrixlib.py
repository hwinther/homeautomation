...
import numpy as np
import wave, sys, os, time, thread, base64, logging, threading
#COLOR
import math
#RGBmatrix
...
def StateSocket(rgbmatrix):
	...
	machine = Machine(model=rgbm, states=['idle', 'settingpixel', 'clearing', 'audiovisualizing', 'settingmatrixfromimage', 'stopaudiovisualizing'], transitions=transitions, initial='idle')
	global queue #:\
	queue = QueueList()
