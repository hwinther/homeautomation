...
import time, random, datetime, os, threading, re, ctypes
...
class Action:
    ...
    def run(self):
        ...
        if not is_connection_usable():  # MySQL 8 hour session timeout fix
            connection.close()
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            print 'exiting..'
            for wt in workerthreads:
                terminate_thread(wt.thread)
